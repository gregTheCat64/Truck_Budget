...
class CalculateTotalExpensesUseCase @Inject constructor() {
    operator fun invoke(driverSalary: Float, fuelUsedUp: Int, fuelPrice: Float, routeDuration: Int,
                        costPerDiem: Int, extraPoints: Int, extraPointsCost: Int, extraExpenses: Int, contractorsCost: Int, roadFee: Int
                        ): Float {
        return driverSalary +
